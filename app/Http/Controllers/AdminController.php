...
/* ***** Start RoomReservation Functions ***** */
    ...
    public function saveReservation(Request $request) {
        ...
        $validated = $request->validate([
            ...
            'email' => 'required_if:guest_type,new|nullable|unique:users,email',
            'mobile' => 'required_if:guest_type,new|nullable|unique:users,mobile',
            ...
            'company_email' => 'required_if:company_type,new|nullable|unique:companies,email',
            'company_mobile' => 'required_if:company_type,new|nullable|unique:companies,mobile',
