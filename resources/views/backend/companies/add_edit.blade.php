      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
              ...
              <div class="x_content">
                  <br/>
                  @if($flag==1)
                      {{ Form::model($data_row,array('url'=>route('save-company'),'id'=>"company-form", 'class'=>"form-horizontal form-label-left")) }}
                      {{Form::hidden('id',null)}}
                  @else
                      {{ Form::open(array('url'=>route('save-company'),'id'=>"company-form", 'class'=>"form-horizontal form-label-left")) }}
                  @endif
                    <div class="row">
