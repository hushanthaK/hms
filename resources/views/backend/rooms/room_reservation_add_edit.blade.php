...
<div class="">
  ...
  <div class="row @if(old('guest_type') != 'existing') hide_elem @endif " id="existing_guest_section">
      <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
              <div class="x_title">
  ...
  <div class="row @if(old('guest_type', 'new') != 'new') hide_elem @endif" id="new_guest_section">
      <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
              <div class="x_title">
