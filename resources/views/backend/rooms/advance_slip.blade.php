...
<body>
    ...
    <div class="container">
        ...
        <div class="row text-center p-rel">
            ...
            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                <img src="{{ checkFile(@$settings['site_logo'], 'uploads/logo/', 'default_logo.jpg') }}"
                    width="{{ @$settings['site_logo_width'] }}" height="{{ @$settings['site_logo_height'] }}"
                    class="inv-logo">
            </div>
            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
...
@if ($data_row->booking_category == 'company')
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
...
<br/>
    <div class="row mt-3">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 px-4">
    ...
    <div>
        <table class="table table-bordered">
            ...
            <tr>
                <td>
                    <ul>
                        <li>SMS and valid photo id proof (passport with VISA, Voter ID card, driving licence , Aadhar
                            card etc.) at the time of check in.</li>
                        <li>Final payment required at the time of check in if pending and invoice will be provided by
                            Aranyak Hotel & Resort.</li>
                        <li>Rooms may be changed due to any unavoidable circumstances.</li>
                        <li>In-case of transfer booking - Any transfer to other hotel / resort, the remaining amount
                            should be paid by the guest.</li>
                        <li>Any damage made to the furniture and fixtures of the hotel by the guest during their stay
                            will be billed to the guest.</li>
                        <li>No pets are allowed inside the hotel premises.</li>
                        <li>In the event of a natural calamity or disaster, poor weather condition, any civil
                            disturbance, suspension of service related to transportation, accommodation etc. Any
                            governmental order or other circumstances which are beyond our control and when safe and
                            smooth tour operation according to the itinerary specified in the travel contract has become
                            impossible or there is valid reason to believe that the tour can’t be continued.</li>
                        <li>Refund and Cancellation Policy:-
                            <ul>
                                <li>25% cancellation charges will apply on total amount after confirmation till 15 days
                                    of travel date.</li>
                                <li>50% cancellation charges will apply on total amount if canceled between 14 - 07 days
                                    of travel date.</li>
                                <li>75% cancellation charges will apply on total amount if canceled between 06- 03 days
                                    of travel date.</li>
                                <li>100% cancellation charges will apply on total amount if canceled on or before 02
                                    days of travel date.</li>
                            </ul>
                        </li>
                        <li>50% advance will be applicable on total amount of the booking charges.</li>
                        <li>The authority of Aranyak Hotel & Resort will not be held responsible for any type of
                            electrical fault and distribution. During load shedding lift, Air- conditioning and geyser
                            will not be functional.</li>
                        <li>SMS opted in.</li>
                    </ul>
                </td>
            </tr>
